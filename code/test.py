...
def main():
    ...
    #                    header = None)
    trainImage = pd.read_csv('data/mnist_images_train.csv',
                       header = None)
    trainLabel = pd.read_csv('data/mnist_labels_train.csv',
                       header = None)
    ...
    testImage = pd.read_csv('data/mnist_images_test.csv',
                       header = None)
    testLabel = pd.read_csv('data/mnist_labels_test.csv',
                       header = None)
    ...
    # 保存参数的训练结果
    np.save('../trainParameters/'+ str(len(parametersB)) + '_layers_' + str(neuronNumList) + '_batchNum_' + str(batchNum) 
